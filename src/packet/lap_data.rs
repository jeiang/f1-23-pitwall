...
pub(crate) struct LapTimes {
    /// Current lap time
    pub(crate) current: Duration,
    /// Last lap time
    pub(crate) last: Duration,
    /// Sector 1 time
    pub(crate) sector1: Duration,
    /// Sector 2 time
    pub(crate) sector2: Duration,
}
...
pub(crate) struct LapData {
    ...
    pub(crate) current_lap: u8,
    pub(crate) pit_status: PitStatus,
    ...
    pub(crate) pit_lap_info: PitLapInfo,
}
...
#[derive(Debug, Clone, PartialEq)]
pub(crate) struct SessionLapData {
